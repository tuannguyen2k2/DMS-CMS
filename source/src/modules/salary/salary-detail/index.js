...
const SalaryPeriodDetailListPage = () => {
    ...
    const searchFields = [
        {
            key: 'developerId',
            placeholder: <FormattedMessage defaultMessage={'Nhân sự'} />,
                    ...
                    <BaseTable
                        onRow={(record) => ({
                            onClick: (e) => {
                                e.stopPropagation();
                                navigate(
                                    routes.salaryPeriodDetailLogListPage.path +
                                        `?salaryPeriodId=${salaryPeriodId}&salaryPeriodName=${salaryPeriodName}&salaryPeriodDetailId=${record.id}&developerName=${record.developer.account.fullName}`,
                                );
                            },
                        })}
                        style={{
