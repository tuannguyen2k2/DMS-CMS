        ...
        <BaseForm id={formId} onFinish={handleSubmit} form={form} onValuesChange={onValuesChange}>
            <Card className="card-form" bordered={false}>
                ...
                <Row gutter={16}>
                    <Col span={12}>
                        <NumericField
                            label={<FormattedMessage defaultMessage="Lương cố định" />}
                            name="salary"
                            min={0}
                    ...
                    <Col span={12}>
                        <NumericField
                            label={<FormattedMessage defaultMessage="Lương thưởng theo dự án" />}
                            name="hourlySalary"
                            min={0}
                            formatter={(value) => `${value}`.replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                            addonAfter={'$'}
