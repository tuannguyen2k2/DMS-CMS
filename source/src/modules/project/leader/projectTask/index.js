...
function LeaderProjectTaskListPage({ setSearchFilter }) {
    ...
    const { data, mixinFuncs, queryFilter, loading, pagination, changePagination, queryParams, serializeParams } =
        useListBase({
            ...
            override: (funcs) => {
                ...
                funcs.getCreateLink = () => {
                    return `${routes.leaderProjectTaskListPage.path}/create?projectId=${projectId}&projectName=${projectName}&active=${active}`;
                };
                funcs.getItemDetailLink = (dataRow) => {
                    return `${routes.leaderProjectTaskListPage.path}/${dataRow.id}?projectId=${projectId}&projectName=${projectName}&active=${active}`;
                };
...
export default LeaderProjectTaskListPage;
