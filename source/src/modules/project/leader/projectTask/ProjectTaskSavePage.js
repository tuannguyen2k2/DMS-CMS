...
function LeaderProjectTaskSavePage() {
    ...
    const setBreadRoutes = () => {
        ...
        if (active) {
            breadRoutes.push({
                ...
                path:
                    routes.leaderProjectTabPage.path + `?projectId=${projectId}&projectName=${projectName}&active=${active}`,
            });
        } else {
            breadRoutes.push({
                breadcrumbName: translate.formatMessage(commonMessage.generalManage),
                path: routes.leaderProjectTabPage.path + `?projectId=${projectId}&projectName=${projectName}`,
            });
        }
...
export default LeaderProjectTaskSavePage;
