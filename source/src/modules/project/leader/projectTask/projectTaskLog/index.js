...
function LeaderProjectTaskLogListPage({ setBreadCrumbName, renderAction, createPermission }) {
        ...
        <PageWrapper
            routes={
                setBreadCrumbName
                    ...
                    : routes.leaderProjectTaskLogListPage.breadcrumbs(
                        commonMessage,
                        paramHead,
...
export default LeaderProjectTaskLogListPage;
