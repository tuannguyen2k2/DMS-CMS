...
function DeveloperProjectTaskLogListPage({ setBreadCrumbName, renderAction, createPermission }) {
    ...
    const columns = [
        ...
        {
            title: translate.formatMessage(commonMessage.gitCommitUrl),
        ...
        <PageWrapper
            routes={
                setBreadCrumbName
                    ...
                    : routes.developerProjectTaskLogListPage.breadcrumbs(
                        commonMessage,
                        paramHead,
...
export default DeveloperProjectTaskLogListPage;
